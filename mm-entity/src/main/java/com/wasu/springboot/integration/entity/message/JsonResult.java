package com.wasu.springboot.integration.entity.message;
...
public class JsonResult implements Serializable{
    ...
    public static JsonResult builError() {
        return new JsonResult(CODE_ERROR);
    }

    public static JsonResult builSuccess() {
